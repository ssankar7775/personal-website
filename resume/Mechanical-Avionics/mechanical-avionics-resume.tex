...
{\bfseries Hermeus}, Flight Test and Operations Intern \hfill May 2024 -- Present \\
Hawthorne, CA
\begin{itemize}
\item Led first \textbf{Vehicle Integrated Test} planning and \textbf{GSE} design/build for a guided projectile, verifying mechanical payload deployment and \textbf{EICD/CICD} configurations.
\item Led \textbf{vehicle integrated test} planning for a spike inlet control system, validating shock positioning and preventing \textbf{engine unstart} at \textbf{supersonic speeds}.
\item Used \textbf{AI coding tools} to build an internal web app for pilots to track \textbf{flight hours} and \textbf{certifications} and for engineers to generate mission \textbf{test cards} from test point matrices.
\end{itemize}
