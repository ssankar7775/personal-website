...
Ann Arbor, MI
\begin{itemize}
\item Architected MERO liquid rocket avionics system (STM32 flight computer, LoRa/SX1276 telemetry, 24V power and ground station interfaces), enabling an integrated and scalable flight-ready avionics architecture.
\item Designed and validated PCB power and telemetry subsystems (24V battery bus, regulated 3.3V rails, current/voltage monitoring, RF integration) using Altium and circuit simulation tools to ensure reliable system performance.
\item Led avionics PDRs and subsystem coordination, establishing requirements, documentation, and testing workflows to mature MERO's flight avionics toward operational readiness.
\end{itemize}
