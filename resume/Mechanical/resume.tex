...
\textbf{Mechanical Design:} Siemens NX, SolidWorks, CAD modeling, tolerance-aware design \\
\textbf{Analysis:} CFD, FEA, MATLAB, Simulink, OpenRocket \\
\textbf{Manufacturing:} Composite fabrication, prototyping, integration, hardware build execution \\
	extbf{Test \& Validation:} Thermal chambers, wind tunnels, instrumentation, verification planning \\
